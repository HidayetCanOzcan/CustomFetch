 ...
 */
export type ErrorTransformer<E extends BaseError> = (error: BaseError, code: number) => E;
/**
 ...
 */
export type ResponseInterceptor<T, E extends BaseError> = (context: ResponseContext<T, E>) => CustomFetchResult<T, E> | Promise<CustomFetchResult<T, E>>;
/**
...
export type CustomFetchReturnType<T, E extends BaseError> = CustomFetchResult<T, E>;
